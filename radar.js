...
vapp = new Vue({ el: "#app", data: { followID: "", gameStartTime: "", lastPacketTime: "", mapType: "", followMe: !0, showTeam: !0, showBox: !0, showAirDrop: !0, showCar: !0, showFlare: !0, showHp: !0, showPlayerName: !0, showItemTop: !0, showItemDuoDuo: !0, showItemBasic: !0, showItemAR: !0, showItemSR: !0, showItemHealth: !0, showItemThrow: !0, showItemAmmo: !0, showItemAll: !0, hideAllItems: !1, followRot: !1, showBack: !0, showArmor2: !0, showHead2: !0, showArmor3: !0, showHead3: !0, showFirstAid: !0, showMedKit: !0, showDrink: !0, showGrenade: !0, showJerryCan: !0, showSmokeBomb: !0, showAmmo556: !0, showAmmo762: !0, showForeGrip: !0, showLowST: !0, showHighST: !0, showARCnFH: !0, showARSuppressor: !0, showARExtended: !0, showARStock: !0, showSRFlashHider: !0, showSRSuppressor: !0, showSRExtended: !0, showSRStock: !0, showPan: !0, showM16A4: !0, showSCAR: !0, showM416: !0, showQBZ: !0, showG36C: !0, showAUG: !0, showAK47: !0, showM762: !0, showGroza: !0, showMini14: !0, showQbu88: !0, showSKS: !0, showMk47: !0, showFnf: !0, showAwm: !0, showM24: !0, showKar98k: !0, showM249: !0, showDP28: !0, nowFps: "", toggleButtonText: "停止刷新" }, methods: { toggleRefresh() { appData.autoRefresh ? (appData.autoRefresh = !1, this.toggleButtonText = "Start Refresh") : (appData.autoRefresh = !0, this.toggleButtonText = " Stop Refresh") }, setFPS(e) { appData.refreshInterval = Math.floor(1e3 / e) }, showNoItems() { this.showItemAll = this.showItemDuoDuo = this.showItemTop = this.showItemBasic = this.showItemAR = this.showItemSR = this.showItemHealth = this.showItemThrow = this.showItemAmmo = this.showItemAll = !1 } } });
...
function getMapSource(e) {
    ...
    const t = a ? "../maptiles" : "http://map.gdlgkj.top/map/maptiles";
...
erangelMapLayer.setVisible(!1), miramarMapLayer.setVisible(!1), savageMapLayer.setVisible(!1), vikendiMapLayer.setVisible(!1), karakinMapLayer.setVisible(!1), chimeraMapLayer.setVisible(!1), erangelMapLayer.setZIndex(0), miramarMapLayer.setZIndex(0), savageMapLayer.setZIndex(0), vikendiMapLayer.setZIndex(0), karakinMapLayer.setZIndex(0), chimeraMapLayer.setZIndex(0), map.addLayer(erangelMapLayer), map.addLayer(miramarMapLayer), map.addLayer(savageMapLayer), map.addLayer(vikendiMapLayer), map.addLayer(karakinMapLayer), map.addLayer(chimeraMapLayer);
...
const showMap = (e = appData.mapName) => {
        if (appData.lastMapName != e) switch (appData.mapName = e, appData.lastMapName = e, console.log("Map Name Is ", appData.mapName), appData.mapName) {
            case "miramar":
                miramarMapLayer.setVisible(!0), erangelMapLayer.setVisible(!1), savageMapLayer.setVisible(!1), vikendiMapLayer.setVisible(!1), karakinMapLayer.setVisible(!1), chimeraMapLayer.setVisible(!1), appData.mapSize = [8192, 8192], appData.mapRatio = 1, appData.mapID = 1;
                break;
            case "erangel":
                miramarMapLayer.setVisible(!1), erangelMapLayer.setVisible(!0), savageMapLayer.setVisible(!1), vikendiMapLayer.setVisible(!1), karakinMapLayer.setVisible(!1), chimeraMapLayer.setVisible(!1), appData.mapSize = [8192, 8192], appData.mapRatio = 1, appData.mapID = 2;
                break;
            case "savage":
                miramarMapLayer.setVisible(!1), erangelMapLayer.setVisible(!1), savageMapLayer.setVisible(!0), vikendiMapLayer.setVisible(!1), karakinMapLayer.setVisible(!1), chimeraMapLayer.setVisible(!1), appData.mapSize = [4096, 4096], appData.mapRatio = 2, appData.mapID = 3;
                break;
            case "vikendi":
                miramarMapLayer.setVisible(!1), erangelMapLayer.setVisible(!1), savageMapLayer.setVisible(!1), vikendiMapLayer.setVisible(!0), karakinMapLayer.setVisible(!1), chimeraMapLayer.setVisible(!1), appData.mapSize = [6144, 6144], appData.mapRatio = 1.333333333, appData.mapID = 4;
                break;
            case "karakin":
                miramarMapLayer.setVisible(!1), erangelMapLayer.setVisible(!1), savageMapLayer.setVisible(!1), vikendiMapLayer.setVisible(!1), karakinMapLayer.setVisible(!0), chimeraMapLayer.setVisible(!1), appData.mapSize = [2048, 2048], appData.mapRatio = 4, appData.mapID = 5;
                break;
            case "chimera":
                miramarMapLayer.setVisible(!1), erangelMapLayer.setVisible(!1), savageMapLayer.setVisible(!1), vikendiMapLayer.setVisible(!1), karakinMapLayer.setVisible(!1), chimeraMapLayer.setVisible(!0), appData.mapSize = [3096, 3096], appData.mapRatio = 8192 / 3096, appData.mapID = 6
        }
    },
